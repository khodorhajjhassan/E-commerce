const Card = () => {
  return (
    <>
      <div className="grid gap-4 m-10 md:grid-cols-3 bg-gray-800 lg:grid-cols-4 justify-center grid-cols-1 sm:grid-cols-2">
        <div className="group border-gray-100/30 flex w-full max-w-xs flex-col self-center overflow-hidden rounded-lg border bg-gray-700 shadow-md">
          ...
          >
            <img
              className="peer absolute top-0 right-0 h-full w-full object-center"
              src="https://www.famousfootwear.com/blob/product-images/20000/44/66/9/44669_pair_feed1000.jpg"
              alt=""
            />
            <img
              className="peer peer-hover:right-0 absolute top-0 -right-96 h-full w-full object-center transition-all delay-100 duration-1000 hover:right-0"
              src="https://www.famousfootwear.com/blob/product-images/20000/44/66/9/44669_top_feed1000.jpg"
              alt=""
            />
            <svg
          ...
          <div className="mt-4 px-5 pb-5">
            ...
            <div className="mt-2 mb-5 flex items-center justify-between">
              ...
              <div className="cursor-pointer">
                <img src="heart.svg" alt="" className="w-8" />
              </div>
            </div>
            <a
              href="/"
